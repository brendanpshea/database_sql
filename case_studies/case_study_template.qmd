...
*An engaging, narrative-driven case story that establishes the setting, the characters (pop-culture or realistic enterprise settings), and the specific actions that led to the conflict. Written in natural, flowing academic textbook prose. Any real-world historical incidents mentioned in the narrative MUST include active, verified, non-fabricated hyperlinks to primary news coverage, official reports, or academic publications.*
...
*A list of primary sources, official government reports, and journalistic investigations used in this case study. All real-world events MUST be backed by active, verified, non-fabricated hyperlinks to their original publications.*

*   [Source Title/Organization](https://example.com/actual-verified-link) - A brief, one-sentence description of the reference's contents and relevance to the case study.
*   [Source Title/Organization](https://example.com/actual-verified-link) - A brief, one-sentence description of the reference's contents and relevance to the case study.
